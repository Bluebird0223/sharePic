...
const CreatePin = ({user}) => {
  ...
  const uploadImage=(e)=>{
    ...
    if(type === 'image/png' || type ==='image/svg' || type === 'image/png' || type ==='image/gif' || type==='image/jpeg' || type === 'image/tiff'){
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      {fields && (
        <p className='text-red-500 mb-5 text-xl transition-all duration-150 ease-in'>Fill all the fields.</p>
      )}
