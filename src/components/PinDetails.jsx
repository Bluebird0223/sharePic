...
const fetchPinDetails=()=>{
  ...
  return (
    ...
    <div className='flex xl-flex-row flex-col m-auto bg-white' style={{maxWidth:'1500px',borderRadius:'32px'}}>
      ...
      <div className='w-full p-5 flex-l xl:min-w-620'>
        ...
        <Link to={`user-profile/${pinDetail.postedBy?._id}`} className='flex gap-2 mt-5 items-center bg-white rounded-lg'>
            ...
            <input className='flex-1 border-grey-100 outline-none border-2 p-2 rounded-2xl focus:border-grey-300'
            type='text'
    ...
    {pins.length >0 ?(
      <>
      <h2 className='text-center font-bold text-2x mt-8 mc-4'>
      Related posts
      </h2>
